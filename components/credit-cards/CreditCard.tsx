...
const CreditCard: React.FC<CreditCardProps> = ({
  ...
  const getThemeGradient = () => {
    switch (theme) {
      case "gold":
        return "linear-gradient(135deg, #7c5c16 0%, #b8860b 50%, #cca43b 100%)";
      case "emerald":
  ...
  // Map theme text colors
  const getThemeTextColor = () => {
    return "#ffffff"; // White text remains high-contrast across all dark gradients
  };

  return (
    <StyledWrapper $gradient={getThemeGradient()} $textColor={getThemeTextColor()}>
      <div className="flip-card">
        <div className="flip-card-inner">
          <div className="flip-card-front">
            <p className="heading_8264">{heading}</p>
...
const StyledWrapper = styled.div<{ $gradient: string; $textColor: string }>`
  .flip-card {
