...
const ContinueButton = ({ children = "Apply Now", className = "", ...props }: ContinueButtonProps) => {
  ...
  // Prevent rendering on the server to avoid hydration mismatches with styled-components
  if (!isMounted) {
    return null; // You can also return a blank <div> with the same height here to prevent layout shift
  }
