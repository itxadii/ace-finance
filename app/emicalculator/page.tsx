        ...
        <div className="container mx-auto max-w-[1200px] relative z-10">
          ...
          <div className="flex justify-center gap-4 mt-10">
            <button
              ...
              className={`px-8 py-3.5 rounded-xl font-bold text-sm flex items-center gap-2 transition-all duration-300 cursor-pointer border-none shadow-[0_4px_12px_rgba(0,0,0,0.03)] ${
                calculatorTab === "emi"
                ...
                <div className="flex flex-wrap gap-2.5 justify-center">
                  {PRESETS.map((lt) => (
                    <button
                      ...
                      className={`px-5 py-2.5 rounded-full font-bold text-xs flex items-center gap-2 transition-all duration-300 cursor-pointer border-none ${
                        activePreset === lt.id
                        ...
                        <div className="flex items-center gap-3">
                          <div className="flex border border-slate-200 rounded-lg overflow-hidden bg-slate-100 p-0.5">
                            <button
                              ...
                              className={`px-2.5 py-1 text-[10px] font-extrabold rounded-md transition-all cursor-pointer border-none ${
                                tenureUnit === "years" ? "bg-white text-emerald-600 shadow-sm" : "bg-transparent text-slate-500"
                              }`}
                            >
                              Years
                            </button>
                            <button
                              ...
                              className={`px-2.5 py-1 text-[10px] font-extrabold rounded-md transition-all cursor-pointer border-none ${
                                tenureUnit === "months" ? "bg-white text-emerald-600 shadow-sm" : "bg-transparent text-slate-500"
                              }`}
                            >
                              Months
                            </button>
                      ...
                      {[
                        ...
                        <div
                          ...
                          className={`flex justify-between items-center p-3.5 rounded-xl ${
                            item.isBorder ? "bg-slate-100/50 border border-slate-200" : "bg-slate-50 border border-slate-50"
                          }`}
                        >
              ...
              <div className="text-center mb-6">
                ...
                <div className="flex gap-3 justify-center">
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-full font-bold text-xs flex items-center gap-2 transition-all duration-300 cursor-pointer border-none ${
                      investmentType === "sip"
